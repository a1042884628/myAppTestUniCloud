			...
			<view class="" style="padding: 45rpx 30rpx;">
				...
				<view class="container-body">
					<view class="container-body-head">
						当前计算结果使用利率:商贷基准利率{{(rate * 100).toFixed(2)}}%
					</view>
					...
					<view class="tabel">
						<view class="tabel-one">
							首付金额 {{ringList[0]?ringList[0].value:0}}万
						</view>
						<view class="tabel-one">
							贷款金额 {{ringList[1]?ringList[1].value:0}}万
						</view>
					</view>
					<view class="tabel">
						<view class="tabel-one">
							支付利息 {{ringList[2]?ringList[2].value:0}}万
						</view>
						<view class="tabel-one">
							贷还款总额 {{(Number(ringList[2]?ringList[2].value:0)+Number(ringList[1]?ringList[1].value:0)).toFixed(2)}}万
						</view>
					</view>
