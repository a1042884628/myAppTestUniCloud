<template>
	<view class="tui-nodata-box" :class="[fixed?'tui-nodata-fixed':'']">
		<image v-if="imgUrl" src="/static/img_nodata.png" class="tui-tips-icon" :style="{width:imgWidth+'rpx',height:imgHeight+'rpx'}"></image>
...
<script>
	export default {
		...
		props: {
			...
			imgUrl: {
				type: String,
				default: "/static/images/img_nodata.png"
			},
			//图片宽度
			imgWidth: {
				type: Number,
